...
$route['assesment'] = 'admin/assesment';
$route['formkpi'] = 'admin/formkpi';
$route['datakpi'] = 'admin/datakpi';
$route['datainsentif'] = 'admin/datainsentif';
$route['dataassesment'] = 'admin/dataassesment';
$route['datashift'] = 'admin/datashift';
$route['dataloktugas'] = 'admin/dataloktugas';
...
$route['exportpegawai'] = 'docs/exportpegawai';
