...
class M_Admin extends CI_Model
{
    ...
    public function crudpgw($typesend)
    {
        if ($typesend == 'addpgw') {
            ...
            $kd_pegawai = increment_string('20041900','01');
						  increment_string('20041910','50');
            ...
            if (!empty(htmlspecialchars($this->input->post('qr_code_use')))) {
            ...
            } elseif (empty(htmlspecialchars($this->input->post('qr_code_use')))) {
                $senddata = [
            ...
            $sendsave = [
                ...
                'bagian_shift' => htmlspecialchars($this->input->post('bagian_shift')),
                'is_active' => htmlspecialchars($this->input->post('is_active')),
                'role_id' => htmlspecialchars($this->input->post('role_id')),
				'loktugas' => htmlspecialchars($this->input->post('loktugas')),
                'date_created' => time()
